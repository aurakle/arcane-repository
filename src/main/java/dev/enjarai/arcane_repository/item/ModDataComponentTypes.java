...
public class ModDataComponentTypes {
    ...
    public static final ComponentType<StorageMetadataComponent> STORAGE_METADATA = register("storage_metadata", builder -> builder.codec(StorageMetadataComponent.CODEC));
    ...
    public static final ComponentType<FilterComponent> FILTER = register("filter", builder -> builder.codec(FilterComponent.CODEC));
